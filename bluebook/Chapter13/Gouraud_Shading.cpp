...
struct Application : public Program {
	...
	void OnInit(Input& input, Audio& audio, Window& window) {
		...
		m_camera = SB::Camera("Camera", glm::vec3(0.0f, 2.0f, 6.0f), glm::vec3(0.0f), SB::CameraType::Perspective, 16.0 / 9.0, 0.9, 0.01, 1000.0);
	...
	void OnUpdate(Input& input, Audio& audio, Window& window, f64 dt) {
		...
		m_cube_rotation = glm::rotate(sin((float)m_time * 0.2f), glm::vec3(0.0, 1.0, 0.0)) * glm::rotate(cos((float)m_time * 0.1f), glm::vec3(1.0, 0.0, 0.0));
